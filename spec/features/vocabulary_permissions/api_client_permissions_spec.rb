...
feature 'Admin Vocabulary API Client Permissions' do
  ...
  scenario 'Creating a permission' do
    ...
    expect(current_path).to eq(
      new_vocabulary_vocabulary_api_client_permission_path(vocabulary.id))
  ...
  scenario 'Editing a permission' do
    visit vocabularies_path(search_term: api_client_permission.vocabulary.id)
    ...
    expect(current_path).to eq(
      edit_vocabulary_vocabulary_api_client_permission_path(
